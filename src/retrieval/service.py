...
class QueryService:
    ...
    def retrieve(self, query: str) -> dict:
        ...
        route = route_query(query, normalized_query=search_query, is_multi_page_hint=query_profile.get("is_multi_page_hint", False))
        ...
        dense_entry = search_dense(self.dense_entry_store, search_query, dense_top_k) if self.dense_entry_store.exists() else []
        dense_field = search_dense(self.dense_field_store, search_query, dense_top_k) if self.dense_field_store.exists() else []
        ...
        if route == "calendar_lookup" and lookup_hits:
            ...
            ranked_lists = [lookup_hits, dense_field, bm25]
